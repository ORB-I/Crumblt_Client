...
void Renderer3D::beginFrame() {
    ...
    m_camera.position = {
        camX + m_distance * cosf(pitchRad) * sinf(yawRad),
...
void Renderer3D::draw3D(const Scene& scene, const std::vector<Player>& players) {
